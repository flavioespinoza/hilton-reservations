			...
			<View style={AppStyle.container}>
				...
				>
					<Text style={AppStyle.arrivalDate}>
						{this.state.arrivalDate.length > 0 ? (
							...
							<Text style={AppStyle.placeholderText}>Arrival
								date</Text>
						)}
					</Text>
				</TouchableOpacity>
				...
				>
					<Text style={AppStyle.departureDate}>
						{this.state.departureDate.length > 0 ? (
							...
							<Text style={AppStyle.placeholderText}>Departure
								date</Text>
						)}
					</Text>
				</TouchableOpacity>
				...
				{this.state.name.length > 0 ? (
					<View>
						...
						<Text
							style={AppStyle.welcome}>{this.state.departureDate}</Text>
						<Text
							style={AppStyle.welcome}>{this.state.arrivalDate}</Text>
					</View>
				) : null}
			</View>
		);
