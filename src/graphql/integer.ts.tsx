...
describe('integer', () => {
    ...
    it('passes on zero', () => assertPasses(integer(), <div a={0} />, 'a'))
    ...
    describe('isRequired', () => {
        it('passes when not required', () => assertPasses(integer(), <div />, 'a'))

        it('fails when required', () => assertFails(integer().isRequired, <div />, 'a'))
    })
})
